...
import { Box, Button, ButtonGroup, Card, CircularProgress, Divider, Flex, Text, useToast } from "@chakra-ui/react";
		...
		<>
			<Flex alignSelf="center" justifySelf="center" alignItems="center" justifyContent="stretch">
				<Card w="75vw" h="75vh" backgroundColor="white" p={8} alignItems="stretch" overflowY="hidden">
					<Flex alignItems="center" h="100%" w="100%" gap="16px" justifyContent="stretch">
							...
							{(isLoading && (
								...
								<>
									...
									<ButtonGroup display="flex" justifyContent="flex-end">
										<Button variant="outline" size="xs" onClick={() => setOpenNewUser(true)}>
											Register
										</Button>
										<Button size="xs" backgroundColor="#014EFF" color="white" onClick={handleLogin}>
											Login
										</Button>
									</ButtonGroup>
								</>
